 ...
 * @since 11/2/2022
 */
class HammingDistance extends EditDistance
{
    /**
     ...
     * @return int
     */
    public static function hamming_dis($firstString, $secondString)
    {
    ...
    private static function checkLength(&$firstString, &$secondString)
    {
